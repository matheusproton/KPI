...
export function WidgetDashboardLayout() {
  ...
  return (
    <div className="relative">
      ...
      <div className="mb-4 flex items-center justify-between p-3 bg-white rounded-none shadow-sm border-b border-l-0 border-r-0 border-t-0">
        {successMessage && (
      ...
      {/* Widget Container */}
      <div className="relative min-h-[1200px] bg-gray-50 border-0 rounded-none overflow-hidden w-full">
        {widgets
